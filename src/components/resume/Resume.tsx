    ...
    <div id="Resume" className={styles.resumesection}>
      <div className={styles.skillscontainer}>
        ...
        <div className={styles.skillsblock}>
          ...
          <p>
            Figma, Invision, Miro, Zeroheight, Userzoom, Dynamic Yield, Illustrator,
            Photoshop
          </p>
        </div>
        <div className={styles.skillsblock}>
          ...
          <p>
            HTML, CSS, SASS, CSS Modules, JavaScript, Typescript, React, Node,
            Webpack, StoryBook, Git, GitHub
          </p>
        </div>
        <div className={styles.skillsblock}>
      ...
      <div className={styles.workexperience}>
        ...
        <div className={styles.resumeblock}>
          <h3 className={styles.resumeblocktitle}>
            Build with Ferguson - Content Personalization
          </h3>
        ...
        <div className={styles.resumeblock}>
          <h3 className={styles.resumeblocktitle}>
            Ferguson Enterprises — Front End Development
          </h3>
          <div className={styles.resumedates}>2020 - 2022</div>
          <ul>
            <li>
              Developed promotional content, landing pages, and site experiences.
            </li>
        ...
        <div className={styles.resumeblock}>
          <h3 className={styles.resumeblocktitle}>
            Ferguson Enterprises — UI/UX Design
          </h3>
          <div className={styles.resumedates}>2017 - 2020</div>
          <ul>
            <li>Creation of UI components and documentation.</li>
            <li>
              Addition of content segment to UI Kit which has increased cross-team
              collaboration and consistencies.
            </li>
            <li>
              Created and maintained content design systems for visual design and
              merchandising teams to create promotional content.
            </li>
            <li>
              Designed landing pages and site experiences to support marketing
              initiatives.
            </li>
            <li>
              Researched and prioritized user issues to create effective design
              solutions.
            </li>
            <li>
              Worked with dedicated UX researchers to test prototypes, and confirm
              hypotheses utilizing user studies.
            </li>
            <li>
              Iterated designs based on user pain points for enhanced user
              experiences.
            </li>
          </ul>
        </div>
